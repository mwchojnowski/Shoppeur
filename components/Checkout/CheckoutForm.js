                ...
                <Row_Name>
                    <HalfDiv>
                        ...
                        <Input__Half
                            ...
                            enableReinitialize={true}
                        /> {(formik.errors.first_name && formik.touched.first_name) && <ErrorDiv>{formik.errors.first_name}</ErrorDiv>}
                    </HalfDiv>
                    <HalfDiv>
                        <H2>Last Name</H2>
                        <Input__Half
                ...
                <Row>
                    <FullDiv>
                        ...
                        <Input__Full
                            ...
                            enableReinitialize={true}
                        />{(formik.errors.address && formik.touched.address) && <ErrorDiv>{formik.errors.address}</ErrorDiv>}
                    </FullDiv>
                </Row>
                <Row>
                    <QuarterDiv>
                    ...
                    <QuarterDiv>
                        ...
                        <Input__Quarter
                            ...
                            enableReinitialize={true}
                        />{(formik.errors.zip && formik.touched.zip) && <ErrorDiv>{formik.errors.zip}</ErrorDiv>}
                    </QuarterDiv>
                    <QuarterDiv>
                        <H3>City</H3>
                        <Input__Quarter
                            ...
                            enableReinitialize={true}
                        />{(formik.errors.city && formik.touched.city) && <ErrorDiv>{formik.errors.city}</ErrorDiv>}
                    </QuarterDiv>
                    <QuarterDiv>
                        <H3>State</H3>
                        <Input__Quarter
                            ...
                            enableReinitialize={true}
                        />{(formik.errors.state && formik.touched.state) && <ErrorDiv>{formik.errors.state}</ErrorDiv>}
                    </QuarterDiv>
                </Row>
                <H1Div>
                ...
                <Row>
                    <RowItemCC>
                        ...
                        <Input__CardNum
                                ...
                                enableReinitialize={true}
                            />{(formik.errors.CC && formik.touched.CC) && <ErrorDiv>{formik.errors.CC}</ErrorDiv>}
                    </RowItemCC>
                    <RowItemCVV>
                        <Title>CVV</Title>
                        <Input__CVV
                                ...
                                enableReinitialize={true}
                            />{(formik.errors.CVV && formik.touched.CVV) && <ErrorDiv>{formik.errors.CVV}</ErrorDiv>}
                    </RowItemCVV>
                </Row>
                <Row>
